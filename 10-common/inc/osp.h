...
#else
// OSP消息头部结构
typedef struct OSP_API CMessage {
	//源结点
	u32 srcnode;
	//目的结点
	u32 dstnode;
...
====================================================================*/
#ifdef _LINUX_
API TASKHANDLE OspTaskCreate(LINUXFUNC pvTaskEntry, const char *szName, u8 byPriority, u32 dwStacksize, MemId dwParam, u16 wFlag, u32 *puTaskID = NULL);
#else
API TASKHANDLE OspTaskCreate(void *pvTaskEntry, const char *szName, u8 byPriority, u32 dwStacksize, MemId dwParam, u16 wFlag, u32 *puTaskID = NULL);
#endif
